...
function Kanban() {
	...
	return (
		<div className="kanban_all_of_it">
			...
			<Np>
				<ol>
					<li>
						...
						<Next></Next>
						That's pretty obvious, you can visualize the workflow on that kanban
						board, whether it's physical or digital it doesn't matter. You can
						see those cards move, you can see them be created, you can see them
						move from the various statuses and you can see where they're at at
						any given time.
						<Next></Next>
						...
						<Bita>
							...
							picture if you will of what's happening can really open your eyes
							to some potential bottlenecks or problems or issues that the team
							is running into or is going to run into and you can then help to
							try to avoid those.
						</Bita>
					</li>
					<li>
						<Bita>
							Number two is limit the work in progress or also known as the WIP.
						</Bita>
						<Next></Next>
						We have talked a lot about this, but with kanban you have that to do
						column, you've got the doing and the done column.{" "}
						<Bita>
							The key thing here is you don't want to just take all those to do
							items and move them to doing because when you have that many items
							in progress you're not actually working on all of them at the same
							time. Instead you want to take items and limit the amount of them
							that you have in progress so people can focus on the particular
							items and get them finished.
						</Bita>{" "}
						<Next></Next>
					...
					<li>
						...
						that are holding up tasks from being completed. So the third general
						practice is really manage the flow of those items, make sure that
						the items are continuing to be flown from status to status with ease
						and efficiency.
					</li>
					<li>
						...
						<Next></Next>
						<Bita>
							What this is referring to kanban is really a framework that can be
							structured to your organization, it can be adjusted. Well with
							that, there's not a lot of structure or rules or policies that
							kanban is really forcing on people. Instead kanban is saying to
							the organization you come up with those policies, you decide when
							you move things from various statuses and the various policies and
							procedures that you'll have in place to help manage that full
							workflow for kanban.
						</Bita>{" "}
						<Next></Next>
						So kanban is sayin: make those policies explicit, write them down,
						make sure everybody's aware of when you move task or how you manage
						block tasks or tasks that are in progress, but are stuck. By having
						those policies explicitly documented, not only will it make it
						easier for everybody in the team to ensure that they're following
						the same type of process, but also help continue to move those tasks
						as efficient as possible.
					</li>
					<li>
						<Bita>Number five is all about implementing feedback loops.</Bita>
						<Next></Next>
						This can be a fluid type of process. Things are always added to the
						to do's and there move through all the various statuses based on
						where that work item is and you just keep moving, as you move it to
						done you're releasing it out to the users, the production
						...
						good place to do those feedback loops. So this is a general practice
						in here to make sure that you don't forget about them. Feedback
						loops are really important to give feedback to the team and to get{" "}
						<Bita>
						...
						<Next></Next>
						Well the easiest way I've seen it done is number one, you still have
						your daily standup, 15 minutes you're looking at the kanban board,
						people are discussing what they're working on, that work in progress
						and it really helps to have the full team understand what
						...
						<Next></Next>
						And the other thing that you can do, is you can still set up like a
						retrospective and this would just be a cadenced meeting, a meeting
						that happens every two weeks or three weeks or month or whatever
						works for your organization in your particular project team, where
						do you get together with the team and you just discuss overall how
						are things going, are there issues, are there things that we can
						adjust to make things easier etc. So you still want to make sure
						that you're implementing those feedback loops even if you're
						utilizing a very fluid kanban process.
					</li>
					<li>
						<Bita>
							Number six is collaborate for improvement, evolve experimentally.
						</Bita>
						<Next></Next>
						<Bita>
							What this is alluding to is you don't take a task and just work
							that solo all the time. There's times where tasks, you need other
							people, you need to collaborate.
						</Bita>{" "}
						You have to have a discussion about how you're going to handle that
						particular work item and how it's going to be completed. And so what
						this is saying is collaborate for improvement, collaborate together
						to make sure that that task is done appropriate and done in the
						right way. Experiment with different ways of doing it and
						accomplishing it and then test those results and see if that
						actually was successful.
						<Next></Next>
						<Bita>
							{" "}
							collaborate to make a good decision as to how to accomplish it and
							then evolve experimentally, learn from different experiment,
			...
			<Np>
				<Bita>
					Kanban has some key metrics that it likes to utilize to understand how
					those tasks are flowing. You can visually see the task flow from the
					to do, doing and done and watch them, you can easily see bottlenecks,
					but metrics help to also give a bigger picture as to how is everything
					flowing.
				</Bita>{" "}
				<Next></Next>
				...
				<Bita>
					So some of the key metrics that are common in kanban are lead time and
					cycle time. These are pretty much prevalent in every single kanban
					through all organizations. Now there's a lot of other metrics that
					could be measured. These are the two that we're going to hammer on
					because of their popularity and some of the kind of common nature in
				...
				<Bita>
					...
					don't care about how much time from the time it was created and put in
					the to do until it was moved to the doing. Instead we're only looking
					at from the time it was a doing, so the time it was marked in
					progress, until the time it was completed. And that's called cycle
					time.
				</Bita>{" "}
				<Next></Next>
				<Bita>
					...
					That's the time it was from creation to completion. Cycle time in this
					case would be five days. That would be the timeframe from in progress
					until done. So just remember lead time. The full time of that work
					item. Cycle time how long it takes for us to cycle through an
					in-progress to get it to complete.
				</Bita>{" "}
				<Next></Next>
				Now these metrics are really important because they can help to identify
				areas of issue. So if you're having too many items that are work in
				progress your cycle time they're going to be crazy. You're going to have
				really long cycle times for a lot of different tasks. It's going to show
				that you're not really focusing on one particular item, you have too
				many items in progress.
				<Next></Next>
				Maybe that's because you like to start and not finish which is a bad
				thing. You want to make sure you're finishing as much as you can. Maybe
				it's because you keep hitting roadblocks or you're waiting for a certain
				resource to be available to help you. And so you have to kind of table
				that one as an in progress item and grab another one to start working
				on.
				<Next></Next>
			...
			<Np>
				Now with these metrics in mind, having a digital or virtual board is
				going to be a ton easier, it's automatically tracking those dates and
				times, who moved it. And so your cycle and your lead times can be
				created pretty easily, you can create a report and pull it out or for
				most of the different online applications you can just utilize their
				canned reports and pull the data out to your lead time and your cycle
				time. So it's pretty quick and painless. Now the physical board, that
				gets a little harder, you have the dates and the times written on the
				back of that card or the back of that sticky note. Somebody needs to
				physically go through flip them all over, write all those dates and
				times down. So then they can generate a report that's going to provide
				the lead time and cycle time. Since this is done normally on a weekly
				basis that can be a lot of like wasted time getting that set up. So most
				teams nowadays that I see, that utilize kanban are utilizing the digital
				or the virtual boards to give them the that auditing. Now the one thing
				they miss, with the physical board if you've never used a physical
				kanban board, it's so exhilarating to be able to take that sticky note
				orthat card and move it from doing to done. It feels so good, it feels
				like you've accomplished something and you feel great walking up and
				moving it to complete. So that is a great feeling that you can't really
				get in the digital side, you're going into a computer and moving the
				card. It still feels good, but not as good as a physical board. So one
				...
				they have their digital board, but they had a smart board that was
				inside of their room, so they had Trello up on the smart board. And so
				people could either go on their computer, if they're not at the office,
				not in that room and they can move the cards and everybody would see
				those cards moving through the process flow and they would get the
				...
				can physically move those cards with their finger to the next column. So
				that was a way, like a really cool adaption, to give the benefits of a
				digital board while also empowering those people that are on site with
