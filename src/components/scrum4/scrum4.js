...
import product from "../../assets/productinc.png";
function Scrum4() {
	return (
		<div className="scrum4_all_of_it">
			<div className="print_not_show">
				...
				<p className="fs-4 mt-3">
					<span className="fw-bold">
						...
						means whenever we are writing this product increment, we are
					...
					<span className="fw-bold">
						...
						<ul>
							<li>
								...
								really think about and empathize with the customer who's
								actually going to be using this software.
							</li>{" "}
							<li>
					...
					<br className="mb-3" />
					<span className="fw-bold">
						Let's look at the format that most of the companies use, as a user
						or type of a user. I want a goal, I want to solve a certain kind of
						problem or that is more for what. The third piece of the story is so
						that I can achieve some value or why. So the who, what, and why can
						be captured by using this format of the user story.
					</span>{" "}
					<br className="mb-3" />
					Now let's look at how do we write a good user story. Is the user story
					just a requirement document? or something that replaces the
					...
					<br className="mb-3" />
					There is a really neat way of thinking about a user story and this is
					an acronym called{" "}
					<span className="fw-bold">
					...
					<ul className="fw-bold">
						<li>
							If you look at the first step, Card. This really means that
							Product Owner after he talks to the customer or the stakeholders
							come back to the team with a (3 / 5) three by five card that
							captures the who, what, and why. And this is just a high-level
							need of the user. Remember, how there is not a lot of description
							added or a lot of time spent in documentation. This is just a
							three by five card that this only has a necessary piece of
							information and that's brought to the team where the conversation
							actually happened.
						</li>{" "}
						<li>
						...
						<li>
							...
							have understood is the same as what product owner or customers
							have in mind, just to avoid any confusion.
						</li>
					</ul>{" "}
				...
				<p className="fs-4 mt-3">
					<span className="fw-bold">
						...
						satisfy the need of the customer that is defined by the product
						owner.
					</span>{" "}
					<span className="fw-bold">
						<em>
					...
					discussing and coming to an agreement on the acceptance criteria of
					the user story.{" "}
					<span className="fw-bold">
					...
					<span className="fw-bold">
						<em>
							The product owner writes the initial acceptance criteria and
							brings them to the team and they decide and come to an common
							agreement on what acceptance criteria should be part of that user
							story.
						</em>
					</span>{" "}
					<br className="mb-3" />
					So let's look at an example. Using our very simple user story format
					we're going to define who, what and why. As a new student, I want to
					be able to create a new account on theagilecoach.com so that I can
					enroll into a course. This is a very simple story. How can we add more
					details and how can we make the story more testable and clear? Well,
					we can add three acceptance criteria on this that defines the entry
					method. Create an account through Linked-In. create an account through
					Google and create an account through Facebook. These three conditions
					are very specific. These are three logging and account creation
					portals and it's really easy for developers to understand they need to
					integrate with these three platforms and allow the new students to log
					in and create accounts from these three social media platforms.
					<br className="mb-3" />
					...
					<span className="fst-italic fw-bold">
						<ol>
							...
							<li>
								The acceptance criteria should be clear and concise, the
								developer should be able to understand it. No poetic language or
					...
					<span className="fst-italic fw-bold">
						One might ask a question how many acceptance criteria per user
						story. This is totally up to teams. I recommend teams, right,
						anywhere between three to seven acceptance criteria and if it's more
						than that, they can always split that user story into two.
					</span>
				</p>
				<h3 className="fs-3 fw-bold">Writing Great User Stories</h3>
				<p className="fs-4 mt-3">
					Let's look at a technique called invest and we're going to look at
					this acronym to write quality user stories. Usually most of the people
					when
					<span className="fst-italic fw-bold">
						they think of a user story, they just think of this simple format as
						a user I want this goal so that I can achieve this.
					</span>{" "}
					...
					invest acronym of the story. What do I mean by that? Let's look at
					these guidelines on writing great user stories.
					<br className="mb-3" />
					...
					<span className="fst-italic fw-bold">
						<ol>
							<li>
								...
								you're writing a user story you don't have any dependency with
								any other user story and a team can spin it and get it to done
								without having to depend on any other user stories.
							</li>{" "}
							<li>
								The second one is negotiable. Whenever the product owner or the
								product manager is coming to the team and he's bringing the
								card, based on his understanding of the needs and the goals of
								the users, this user story should be negotiable. Meaning once
								after talking to the team, if the product owner has a better
								idea this user story should be flexible so that it can change
								and adapt to the needs of the user.
							</li>{" "}
							<li>
								The third one is valuable, that this user story has some
								concrete value to the users.
							</li>{" "}
							<li>
								The 4th one is estimatable, this just means if you have a user
								story, you should have some idea on how much complexity this
								user story has.
							</li>{" "}
							<li>
						...
						And if you pay attention to these six things you will be able to
						come up with great user stories.
					</span>{" "}
				</p>
			</div>
			...
			<p className="fs-4 mt-3">
				...
				increment is.
				<br className="mb-3" />
				<img src={product} alt="product" height="50%" width="100%" />
				<br className="mb-3 mt-3" />
				...
				<br className="mb-3" />
				Now let's take a look at an agile methodology. It takes these stages and
				it still uses them, but it flips them on their head. So instead of going
				from stage to stage to stage throughout time, the stages are listed
				vertically. So when you now have a slice and you do a vertical slice,
				that's where that term comes from, so you do a vertical slice on that
				product now you have this product increment. So at a certain point of
				time which is a sprint or a time-box or within that 1 to 4 week time
				frame, you are creating a potentially shippable product increment. Now
				you do that over and over on every single sprint and you're creating
				these product increments. To explain this with another type of example,
				everybody's had some type of application software either on their phone
				or on some type of desktop computer that once every couple weeks, once a
				month that you get some type of update it's now version 1.4.6 and then
				it's 1.4.7 little bit later and a couple of weeks, 1.4.8, what they're
				doing is they're shipping new product increments the shipping to new
				features and changes and updates that they've made to the application.
				And they're doing that over and over and over. So you can start to
				realize that value and that product increments it's only going to
				contain a couple of features, a couple of new things, a couple of
				changes, but when they do that over and over and over and they continue
				to deliver that to you, you're able to continue to realize that value
				rather than waiting for all of their features as part of this project to
				be complete. So product increment is a vertical slice of a potentially
				shippable product that's developed as part of a sprint time-box.
			</p>
		</div>
	);
}
